...
const OrderSchema = new mongoose.Schema(
  {
    ...
    type: {
      type: String,
      enum: ["dine-in", "takeaway", "takeaway-service", "delivery"],
      required: true,
    },
    status: {
      type: String,
      enum: ["open", "created", "sent", "accepted", "rejected", "preparing", "ready", "served", "completed", "closed", "cancelled"],
      default: "created",
    },
      ...
      type: [
        {
          ...
          changedRole: { type: String, required: true },
          changedAt: { type: Date, default: Date.now },
          source: { type: String, default: "orders-api" },
